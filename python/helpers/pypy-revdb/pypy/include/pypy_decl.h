...
PyAPI_FUNC(int) PyPyAnySet_Check(PyObject *arg0);
#define PyAnySet_CheckExact PyPyAnySet_CheckExact
PyAPI_FUNC(int) PyPyAnySet_CheckExact(PyObject *arg0);
...
PyAPI_FUNC(char *) PyPyByteArray_AsString(PyObject *arg0);
#define PyByteArray_Check PyPyByteArray_Check
PyAPI_FUNC(int) PyPyByteArray_Check(PyObject *arg0);
#define PyByteArray_CheckExact PyPyByteArray_CheckExact
PyAPI_FUNC(int) PyPyByteArray_CheckExact(PyObject *arg0);
#define PyByteArray_Concat PyPyByteArray_Concat
PyAPI_FUNC(PyObject *) PyPyByteArray_Concat(PyObject *arg0, PyObject *arg1);
#define PyByteArray_FromObject PyPyByteArray_FromObject
PyAPI_FUNC(PyObject *) PyPyByteArray_FromObject(PyObject *arg0);
#define PyByteArray_FromStringAndSize PyPyByteArray_FromStringAndSize
PyAPI_FUNC(PyObject *) PyPyByteArray_FromStringAndSize(const char *arg0, Py_ssize_t arg1);
#define PyByteArray_Resize PyPyByteArray_Resize
PyAPI_FUNC(int) PyPyByteArray_Resize(PyObject *arg0, Py_ssize_t arg1);
#define PyByteArray_Size PyPyByteArray_Size
PyAPI_FUNC(Py_ssize_t) PyPyByteArray_Size(PyObject *arg0);
...
PyAPI_FUNC(int) PyPyDateTime_GET_DAY(void *arg0);
#define PyDateTime_GET_MONTH PyPyDateTime_GET_MONTH
PyAPI_FUNC(int) PyPyDateTime_GET_MONTH(void *arg0);
#define PyDateTime_GET_YEAR PyPyDateTime_GET_YEAR
PyAPI_FUNC(int) PyPyDateTime_GET_YEAR(void *arg0);
#define PyDateTime_TIME_GET_HOUR PyPyDateTime_TIME_GET_HOUR
PyAPI_FUNC(int) PyPyDateTime_TIME_GET_HOUR(void *arg0);
#define PyDateTime_TIME_GET_MICROSECOND PyPyDateTime_TIME_GET_MICROSECOND
PyAPI_FUNC(int) PyPyDateTime_TIME_GET_MICROSECOND(void *arg0);
#define PyDateTime_TIME_GET_MINUTE PyPyDateTime_TIME_GET_MINUTE
PyAPI_FUNC(int) PyPyDateTime_TIME_GET_MINUTE(void *arg0);
#define PyDateTime_TIME_GET_SECOND PyPyDateTime_TIME_GET_SECOND
PyAPI_FUNC(int) PyPyDateTime_TIME_GET_SECOND(void *arg0);
...
PyAPI_FUNC(PyObject *) PyPyDescr_NewMethod(PyTypeObject *arg0, PyMethodDef *arg1);
#define PyDictProxy_Check PyPyDictProxy_Check
PyAPI_FUNC(int) PyPyDictProxy_Check(PyObject *arg0);
#define PyDictProxy_CheckExact PyPyDictProxy_CheckExact
PyAPI_FUNC(int) PyPyDictProxy_CheckExact(PyObject *arg0);
...
PyAPI_FUNC(int) PyPyDict_Merge(PyObject *arg0, PyObject *arg1, int arg2);
...
PyAPI_FUNC(double) PyPyFloat_AS_DOUBLE(void *arg0);
...
PyAPI_FUNC(Signed) PyPyInt_AS_LONG(void *arg0);
...
PyAPI_FUNC(Py_ssize_t) PyPyList_GET_SIZE(void *arg0);
...
PyAPI_FUNC(PyObject *) PyPyList_SET_ITEM(void *arg0, Py_ssize_t arg1, PyObject *arg2);
...
PyAPI_FUNC(int) PyPyMemoryView_Check(PyObject *arg0);
#define PyMemoryView_CheckExact PyPyMemoryView_CheckExact
PyAPI_FUNC(int) PyPyMemoryView_CheckExact(PyObject *arg0);
#define PyMemoryView_FromBuffer PyPyMemoryView_FromBuffer
PyAPI_FUNC(PyObject *) PyPyMemoryView_FromBuffer(Py_buffer *arg0);
#define PyMemoryView_FromObject PyPyMemoryView_FromObject
PyAPI_FUNC(PyObject *) PyPyMemoryView_FromObject(PyObject *arg0);
#define PyMemoryView_GET_BASE PyPyMemoryView_GET_BASE
PyAPI_FUNC(PyObject *) PyPyMemoryView_GET_BASE(PyObject *arg0);
#define PyMemoryView_GET_BUFFER PyPyMemoryView_GET_BUFFER
PyAPI_FUNC(Py_buffer *) PyPyMemoryView_GET_BUFFER(PyObject *arg0);
...
PyAPI_FUNC(int) PyPyOS_InterruptOccurred(void);
...
PyAPI_FUNC(int) PyPyObject_AsCharBuffer(PyObject *arg0, const char **arg1, Py_ssize_t *arg2);
...
PyAPI_FUNC(PyObject *) PyPyObject_Format(PyObject *arg0, PyObject *arg1);
...
PyAPI_FUNC(void *) PyPyObject_Malloc(Unsigned arg0);
...
PyAPI_FUNC(void *) PyPyObject_Realloc(void *arg0, Unsigned arg1);
...
PyAPI_FUNC(PyObject *) PyPySequence_Fast_GET_ITEM(void *arg0, Py_ssize_t arg1);
#define PySequence_Fast_GET_SIZE PyPySequence_Fast_GET_SIZE
PyAPI_FUNC(Py_ssize_t) PyPySequence_Fast_GET_SIZE(void *arg0);
#define PySequence_Fast_ITEMS PyPySequence_Fast_ITEMS
PyAPI_FUNC(PyObject **) PyPySequence_Fast_ITEMS(void *arg0);
...
PyAPI_FUNC(PyObject *) PyPySequence_ITEM(void *arg0, Py_ssize_t arg1);
#define PySequence_InPlaceConcat PyPySequence_InPlaceConcat
PyAPI_FUNC(PyObject *) PyPySequence_InPlaceConcat(PyObject *arg0, PyObject *arg1);
#define PySequence_InPlaceRepeat PyPySequence_InPlaceRepeat
PyAPI_FUNC(PyObject *) PyPySequence_InPlaceRepeat(PyObject *arg0, Py_ssize_t arg1);
...
PyAPI_FUNC(Py_ssize_t) PyPySet_GET_SIZE(void *arg0);
...
PyAPI_FUNC(char *) PyPyString_AS_STRING(void *arg0);
...
PyAPI_FUNC(int) PyPyTZInfo_Check(PyObject *arg0);
#define PyTZInfo_CheckExact PyPyTZInfo_CheckExact
PyAPI_FUNC(int) PyPyTZInfo_CheckExact(PyObject *arg0);
...
PyAPI_FUNC(char *) PyPyUnicode_AS_DATA(void *arg0);
#define PyUnicode_AS_UNICODE PyPyUnicode_AS_UNICODE
PyAPI_FUNC(wchar_t *) PyPyUnicode_AS_UNICODE(void *arg0);
...
PyAPI_FUNC(PyObject *) PyPyUnicode_Concat(PyObject *arg0, PyObject *arg1);
...
PyAPI_FUNC(Py_ssize_t) PyPyUnicode_GET_DATA_SIZE(void *arg0);
#define PyUnicode_GET_SIZE PyPyUnicode_GET_SIZE
PyAPI_FUNC(Py_ssize_t) PyPyUnicode_GET_SIZE(void *arg0);
...
PyAPI_FUNC(int) PyPyWeakref_Check(PyObject *arg0);
#define PyWeakref_CheckProxy PyPyWeakref_CheckProxy
PyAPI_FUNC(int) PyPyWeakref_CheckProxy(PyObject *arg0);
#define PyWeakref_CheckRef PyPyWeakref_CheckRef
PyAPI_FUNC(int) PyPyWeakref_CheckRef(PyObject *arg0);
#define PyWeakref_CheckRefExact PyPyWeakref_CheckRefExact
PyAPI_FUNC(int) PyPyWeakref_CheckRefExact(PyObject *arg0);
#define PyWeakref_GET_OBJECT PyPyWeakref_GET_OBJECT
PyAPI_FUNC(PyObject *) PyPyWeakref_GET_OBJECT(void *arg0);
...
PyAPI_FUNC(int) _PyPyComplex_AsCComplex(PyObject *arg0, struct Py_complex_t *arg1);
#define _PyComplex_FromCComplex _PyPyComplex_FromCComplex
PyAPI_FUNC(PyObject *) _PyPyComplex_FromCComplex(struct Py_complex_t *arg0);
#define _PyDateTime_FromDateAndTime _PyPyDateTime_FromDateAndTime
PyAPI_FUNC(PyObject *) _PyPyDateTime_FromDateAndTime(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, PyObject *arg7, PyTypeObject *arg8);
...
PyAPI_FUNC(PyObject *) _PyPyDate_FromDate(int arg0, int arg1, int arg2, PyTypeObject *arg3);
#define _PyDelta_FromDelta _PyPyDelta_FromDelta
PyAPI_FUNC(PyObject *) _PyPyDelta_FromDelta(int arg0, int arg1, int arg2, int arg3, PyTypeObject *arg4);
...
PyAPI_FUNC(void) _PyPyImport_AcquireLock(void);
#define _PyImport_ReleaseLock _PyPyImport_ReleaseLock
PyAPI_FUNC(int) _PyPyImport_ReleaseLock(void);
...
PyAPI_FUNC(PyObject *) _PyPyTime_FromTime(int arg0, int arg1, int arg2, int arg3, PyObject *arg4, PyTypeObject *arg5);
...
PyAPI_FUNC(Signed) _PyPy_HashDouble(double arg0);
