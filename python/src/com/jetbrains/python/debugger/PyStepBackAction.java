...
public class PyStepBackAction extends XDebuggerActionBase {
  private final XDebuggerSuspendedActionHandler myStepBackHandler;

  public PyStepBackAction() {
    super();
    myStepBackHandler = new XDebuggerSuspendedActionHandler() {
      @Override
      protected void perform(@NotNull final XDebugSession session, final DataContext dataContext) {
        ...
        if (debugProcess instanceof PyDebugProcess) {
          ...
          pyDebugProcess.startStepBack(debugProcess.getSession().getSuspendContext());
        }
      }
